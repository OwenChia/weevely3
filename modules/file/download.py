...
class Download(Module):
    ...
    def run(self):
        ...
        if expected_md5:
            check_md5 = lambda r: r is not None and hashlib.md5(base64.b64decode(r)).hexdigest() == expected_md5
        else:
            log.debug(messages.module_file_download.skipping_md5_check)
            check_md5 = lambda r: r is not None and bool(base64.b64decode(r))
