...
class Tcp(Module):
    ...
    def run(self):
        ...
        for vector in self.vectors:
            ...
            if self.args.get(
                    'vector') and self.args.get('vector') != vector.name:
                continue
            ...
            if not urlparsed.hostname:
                log.debug(messages.module_backdoor_tcp.error_parsing_connect_s
                          % self.args['port'])
                continue
            ...
            try:
                ...
                log.debug(
                    ...
                    (urlparsed.hostname, self.args['port'], e))
