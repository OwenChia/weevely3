...
class Disablefunctionbypass(Module):
    ...
    def _clean(self, htaccess_absolute_path, script_absolute_path):
        ...
        log.warning('Deleting %s and %s' % (htaccess_absolute_path,
                                            script_absolute_path))
        self.vectors.get_result(
            'remove', format_args={'path': htaccess_absolute_path})
        self.vectors.get_result(
            'remove', format_args={'path': script_absolute_path})
    ...
    def _install(self):
        ...
        log.warning(messages.module_audit_disablefunctionbypass.
                    cgi_installed_remove_s_s % (htaccess_absolute_path,
                                                script_absolute_path))
        log.warning(
