...
class FileUpload(BaseTest):
    ...
    def test_upload(self, log_captured):
        ...
        # Upload content
        self.assertTrue(
            self.run_argv(['test_file_upload/f1', '-content', 'CONTENT']))
    ...
    def test_upload_fwrite(self, log_captured):
        ...
        self.assertTrue(
            self.run_argv([
                'test_file_upload/f3', '-content', 'CONTENT', '-vector',
                'fwrite'
            ]))
    ...
    def test_upload_errs(self, log_captured):
        ...
        self.assertFalse(
            self.run_argv(['asd/asd/asd/asd', '-content', 'CONTENT']))
    ...
    def test_upload_overwrite(self, log_captured):
        ...
        # Try to overwrite
        self.assertFalse(
            self.run_argv(['test_file_upload/ok.test', '-content', 'CONTENT']))
        self.assertEqual(
            log_captured.records[-1].msg,
            messages.generic.error_file_s_already_exists %
            'test_file_upload/ok.test')

        # Now force
        self.assertTrue(
            self.run_argv(
                ['test_file_upload/ok.test', '-content', 'CONTENT', '-force']))
    ...
    def test_upload_overwrite_fwrite(self, log_captured):
        ...
        self.assertFalse(
            self.run_argv([
                'test_file_upload/ok.test', '-content', 'CONTENT', '-vector',
                'fwrite'
            ]))
        self.assertEqual(
            log_captured.records[-1].msg,
    ...
    def test_upload_binary(self, log_captured):
        ...
        # Upload content
        self.assertTrue(
            self.run_argv(['test_file_upload/f7', '-content', binary_content]))
    ...
    def test_upload_binary_fwrite(self, log_captured):
        ...
        self.assertTrue(
            self.run_argv([
                'test_file_upload/f9', '-content', binary_content, '-vector',
                'fwrite'
            ]))
